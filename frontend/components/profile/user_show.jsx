...
class UserShow extends React.Component {
  constructor(props) {
    ...
    this.state = {
      selectedPane: 0,
      paneContent: <UserBoardsContainer user={this.props.user} />
    };
  ...
  selectPaneContent(num) {
    switch (num) {
      ...
      case 1:
        return this.setState({
          paneContent: <UserBingesContainer user={this.props.user} />
        });
      case 2:
        return this.setState({
          paneContent: <UserBoardsContainer user={this.props.user} />
      ...
      <div>
        ...
        <div className="profile">
          ...
          <div className="user-profile-content">
            <div className="public-content">{this.state.paneContent}</div>
          </div>
        </div>
      </div>
    );
